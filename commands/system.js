...
cmd({
	...
	pattern: "alive",
        ...
        async(Void, citel, text, isAdmins) => {
          ...
          await Void.sendMessage(citel.chat, { audio: {url : 'https://telegra.ph/file/6a0f06edd76deda2b8d62.mp3',}, mimetype: 'audio/mpeg', ptt: true }, { quoted: citel, });
